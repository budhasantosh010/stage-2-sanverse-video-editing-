...
|---|---|---|---|
| G0 | Durable product truth, governance, architecture constraints, and approved next plan | In progress | Local verification, coherent commit, remote baseline, owner approval |
| G1 | Approved Studio workflow plus measured renderer decision | Pending | Usability walkthrough and reproducible spike results |
