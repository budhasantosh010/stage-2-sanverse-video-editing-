...
| G1 | Owner-tested runnable Home-to-Studio workflow plus measured renderer decision | In progress | Local web walkthrough on strict port 2000 and reproducible renderer-spike results |
