...
export const TIMELINE_COMMAND_LABELS: Readonly<Record<TimelineCommand, string>> = Object.freeze({
  ...
  'tool-standard-trim': 'Choose Standard Trim',
  'tool-ripple-trim': 'Choose Ripple Trim',
  'tool-roll': 'Choose Roll',
  'tool-slip': 'Choose Slip',
  'tool-slide': 'Choose Slide',
  'tool-rate-stretch': 'Choose Rate Stretch',
  'trim-start-playhead': 'Trim the start to the playhead',
  'trim-end-playhead': 'Trim the end to the playhead',
  'ripple-trim-start-playhead': 'Ripple trim the start to the playhead',
  'ripple-trim-end-playhead': 'Ripple trim the end to the playhead',
  'extend-edit': 'Extend the nearest edit to the playhead',
  'shuttle-reverse': 'Shuttle backwards',
  'shuttle-stop': 'Stop shuttle playback',
  'shuttle-forward': 'Shuttle forwards',
  'dynamic-trim': 'Enter or leave Dynamic Trim',
  'toggle-audio-scrubbing': 'Turn Audio Scrubbing on or off',
})
...
const SANVERSE_BINDINGS = bindingsOf({
  ...
  'go-to-start': 'Home',
  'go-to-end': 'End',
  'tool-standard-trim': 'T',
  'tool-ripple-trim': 'Shift+T',
  'tool-roll': 'R',
  'tool-slip': 'Y',
  'tool-slide': 'U',
  'tool-rate-stretch': 'Shift+R',
  'trim-start-playhead': 'Q',
  'trim-end-playhead': 'W',
  'ripple-trim-start-playhead': 'Shift+Q',
  'ripple-trim-end-playhead': 'Shift+W',
  'extend-edit': 'E',
  'shuttle-reverse': 'J',
  'shuttle-stop': 'K',
  'shuttle-forward': 'L',
  'dynamic-trim': 'D',
  'toggle-audio-scrubbing': 'Shift+A',
})
