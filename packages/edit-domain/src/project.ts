...
export {
  ...
  visualPropertyBaseValue,
  withVisualPropertyBaseValue,
  type EditorAnimationInterpolationKindV1,
  type EditorAnimationOwnerKindV1,
  type EditorAnimationPropertyCapabilityV1,
  type EditorAnimationPropertyIdV1,
  type EditorAnimationRefusalCodeV1,
  type EditorAnimationRefusalV1,
  type EditorAnimationTargetKindV1,
  type EditorAnimationTargetRefV1,
  type EditorAnimationTimeBasisV1,
  type EditorAnimationTimeContextV1,
  type EditorAnimationTrackPlanV1,
  type EditorAnimationTrackStateV1,
  type EditorAnimationUnitV1,
  type EditorAnimationVisibleRangeV1,
  type EditorKeyframeAddressV1,
  type EditorKeyframeClipboardV1,
  type EditorKeyframeMoveV1,
  type EditorKeyframeSelectionV1,
  type EditorKeyframeValueUpdateV1,
